...
from aesara.tensor.nnet.batchnorm import _specify_shapes_of_size1
...
def test_batch_normalization_train():
    ...
    for axes in ("per-activation", "spatial", (1, 2, 3, 4)):
        for vartype in (tensor5, tensor3, vector):
            ...
            scale2 = _specify_shapes_of_size1(scale, *axes2)
            bias2 = _specify_shapes_of_size1(bias, *axes2)
    ...
    for axes in ("per-activation", "spatial", (1, 2, 3, 4)):
        for vartype in (tensor5, tensor3, vector):
            ...
            scale2, bias2, mean2, var2 = (
                _specify_shapes_of_size1(t, *axes2) for t in (scale, bias, mean, var)
            )
